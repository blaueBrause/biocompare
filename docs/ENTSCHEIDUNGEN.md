...
- Aus Vergleichsmerkmalen werden keine Punktwerte, Rankings oder Gesamtnoten berechnet.
- `data/befunde.json` ist kanonisch.
- `data/erkenntnisse.json` löschen.
- STARK nur ergänzend.
- Repository ist Projektgedächtnis.
